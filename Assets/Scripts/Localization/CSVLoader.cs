...
public class CSVLoader : MonoBehaviour
{
    ...
    public void LoadCSV()
    {
        csvFile = Resources.Load<TextAsset>("Localization/Dictionary");
    }
    ...
    public void Add(string key, string value)
    {
        ...
        File.AppendAllText("Assets/Resources/Localization/Dictionary.csv", appended);
    ...
    public void Remove(string key)
    {
        ...
        if (index > -1)
        {
            ...
            File.WriteAllText("Assets/Resources/Localization/Dictionary.csv", replaced);
        }
    }
